...
const int BOMB_INITIAL_SPEED_X = WINDOW_INITIAL_WIDTH / 2;
const int BOMB_INITIAL_SPEED_Y = BOMB_INITIAL_SPEED_X;
const int BOMB_INITIAL_DECELERATION_X = BOMB_INITIAL_SPEED_X / 4;
const int BOMB_INITIAL_DECELERATION_Y = BOMB_INITIAL_DECELERATION_X;
